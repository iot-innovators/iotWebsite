...
const Footer = () => {
      ...
      <div className="p-10 flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 mt-3">
            {footerLists.map((f) => (
              <li key={f.index} className="cursor-pointer hover:text-gray-600">
                {f.name}
              </li>
            ))}
          </ul>
  ...
  onClick={() => window.location.href = 'mailto:iot.innovators@heraldcollege.edu.np'}
>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <div>
              ...
              >
                <FaInstagram color="purple" className="cursor-pointer text-xl" />
                <span className="cursor-pointer font-bold  hover:text-gray-600">
