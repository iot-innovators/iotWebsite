  ...
  return (
    <div className="flex gap-4 ">
      <a href="https://www.facebook.com/iotinnovatorscommunity" target="_blank">
        <BsFacebook className="text-white hover:text-gray-400 size-6 " />
      </a>
      <a
        href="https://www.instagram.com/devcorps.iotinnovators"
        target="_blank"
      >
        <BsInstagram className="text-white size-6 hover:text-gray-400  " />
      </a>
      <a href="https://www.linkedin.com/company/iotinnovators/" target="_blank">
        <BsLinkedin className="text-white size-6 hover:text-gray-400 " />
      </a>
    </div>
  );
};
